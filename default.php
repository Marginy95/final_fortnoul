...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.hostinger.fr/" rel="nofollow"><img src="https://raw.githubusercontent.com/hostinger/banners/master/hostinger_welcome/images/hostinger-logo.png" width="120"></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="https://www.hostinger.fr/affilie/login" rel="nofollow"><i aria-hidden="true" class="fa fa-user"></i> Affiliés</a>
                </li>
                <li>
...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>Votre compte a été créé</h1><i></i>
        ...
        <div class="column-wrap clearfix">
            ...
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.fr/base-connaissances" rel="nofollow">En savoir plus</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
        ...
        <div class="footer">
            <div class="row">
                ...
                <div class="copyright text-center">
                    Hostinger © 2019. Tous droits réservés
                </div>
            </div>
        </div>
    </div>
